...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "com/bookshop/books/test/integration/FirstJourney",
    "com/bookshop/books/test/integration/BooksListJourney",
    "com/bookshop/books/test/integration/BooksObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
