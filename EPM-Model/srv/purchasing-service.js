...
//       po.statusCriticality = 2;   // Yellow
//     else if (po.status === 'Draft')
//       po.statusCriticality = 1;   // Grey
...
//     if (po.priority === 'High')
//       po.priorityCriticality = 1; // Red
//     else if (po.priority === 'Medium')
//       po.priorityCriticality = 2; // Yellow
//     else
//       po.priorityCriticality = 3; // Green
//   });
