...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "com/inventory/products/test/integration/FirstJourney",
    "com/inventory/products/test/integration/ProductsListJourney",
    "com/inventory/products/test/integration/ProductsObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
