...
sap.ui.define([
    ...
    function journey() {
        ...
        opaTest("Check filter bar", function (Given, When, Then) {
            Then.onTheProductsList.onFilterBar().iCheckFilterField("productName");
            Then.onTheProductsList.onFilterBar().iCheckFilterField("price");
            Then.onTheProductsList.onFilterBar().iCheckFilterField("stock");
        });

        opaTest("Check table columns and actions", function (Given, When, Then) {
            Then.onTheProductsList.onTable().iCheckColumns(undefined, {"productName":{"header":"Product Name"},"price":{"header":"Price"},"stock":{"header":"Stock"}});
