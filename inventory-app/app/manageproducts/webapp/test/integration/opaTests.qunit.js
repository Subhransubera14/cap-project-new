...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "com/inventory/manageproducts/test/integration/FirstJourney",
    "com/inventory/manageproducts/test/integration/ProductsListJourney",
    "com/inventory/manageproducts/test/integration/ProductsObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
