...
sap.ui.define([
    ...
    function journey() {
        ...
        opaTest("Check body sections of the Object Page", function (Given, When, Then) {
            Then.onTheProductsObjectPage.iCheckSection({ section: "ProductDetails" });
            Then.onTheProductsObjectPage.onForm({ section: "ProductDetails" }).iCheckField({ property: "productName" });
            Then.onTheProductsObjectPage.onForm({ section: "ProductDetails" }).iCheckField({ property: "price" });
            Then.onTheProductsObjectPage.onForm({ section: "ProductDetails" }).iCheckField({ property: "stock" });
            Then.onTheProductsObjectPage.onForm({ section: "ProductDetails" }).iCheckField({ property: "stockCriticality" });
       });
